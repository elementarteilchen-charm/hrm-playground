...
<!-- 1 -->        
        <main class="mt-12">
            <HRMFeedback v-if="modus == 'MA'" 
                ...
                <p>
                    Hier steht ein erläuternder Einleitungstext, damit die MA*innen einen Anhaltspunkt haben.
                </p>
                
                <div class="mt-3 space-y-3">
                    <InputTextarea 
                        label="Meine Vorstellung ist:" 
                        class="h-32 w-full"></InputTextarea>
                </div>
            </HRMFeedback>

            <HRMFeedback v-if="modus == 'FK'" kategorie="# Langfristige Entwicklungsziele / Wünsche" frage="Wunsch / Vorstellung Mitarbeiter*in ">
            ...
            <HRMFeedback v-if="modus == 'GEMEINSAM'" kategorie="# Langfristige Entwicklungsziele/Wünsche" frage="Wunsch/Vorstellung Mitarbeiter*in ">
                <h3 class="font-bold">Feedback:</h3>
...
<!-- 2 -->
        <main class="mt-12">
            <HRMFeedback v-if="modus == 'GEMEINSAM'" kategorie="# Arbeitszeit" frage="Momentanes Arbeitszeitmodell">
