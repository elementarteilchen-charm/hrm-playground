    ...
    <div style="background-image: url(/hintergrund.svg);" class="h-screen bg-no-repeat bg-center bg-top">
        <header class="py-6 px-6">
            <div class="grid grid-cols-2">
                <div>
                    <h2 class="font-bold italic text-white text-2xl">WALTER GROUP <span class="text-Gruen-logo">ZUKUNFTSGESPRÄCH</span></h2>
                </div>
            ...
            <div class="hidden mt-6 grid grid-cols-3 text-white place-items-center ">
                <div>
...
<!-- 1 -->        
        ...
        <HRMFeedback 
                ...
                speichernText="Speichern und absenden"
                :modus="modus">
            <p>
...
<!-- 4 -->
        <main class="pb-12">
            <HRMFeedback 
                ...
                kategorie="# Abschluss" 
                frage="Feedback" 
                speichernText="Speichern & abschließen">
