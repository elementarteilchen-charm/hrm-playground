...
<template>
    ...
    <header class="px-8 py-4">
        <NavigationHraBreadcrumb 
                ...
                aktuell="Langzeitkrankenstand"/>
        <HRAMitarbeiterInfoBox headline="Langzeitkrankenstand" />
    </header>
        ...
        <div class="bg-white border  rounded">
            <div class="px-4 py-4 ">
                <div v-show="'Dauer' == activeTab" class="px-2 pt-2 grid grid-rows-1 gap-4">
                    <LayoutFormSection title="Beginn und Ende des Krankenstands">
                        <div class=" grid grid-cols-[minmax(15rem,min-content)_1fr] gap-2 items-center">
                            <InputDate label="Beginn" />
                            <InputDate label="Voraussichtliches Ende" />
                            <InputDate label="Voraussichtliches Wiedereintrittsdatum" />
                        </div>
                    </LayoutFormSection>
                    <div class="">
                ...
                <div v-show="'Dokumente' == activeTab" class="px-2 pt-2 grid grid-rows-1 gap-4">
                    <LayoutFormSection title="Bemerkung">
                        <div>
                            <InputTextarea label="Infos" />    
                        </div>
                    </LayoutFormSection>
                    <div>
                        <InputButton >Speichern</InputButton>
