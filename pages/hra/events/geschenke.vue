...
const tabs = [
    ...
    'Namensänderungen',
    'Ummeldungen',
    'Arbeitszeitmodelländerungen',
    'Signaturänderungen',
    'Visitenkartenänderungen',
    'Erhalt Zusatzqualifikationen',
    'Geschenke',
    'Jubiläum',
];
            ...
            <main class="grid lg:grid-cols-[minmax(12rem,auto)_1fr]">
                ...
                <div class="px-4 py-4 border-l pb-12">
                    <div v-show="tabs[0] == activeTab.tab" class="px-2 pt-2 grid grid-rows-1 gap-4">
                        <div @click="zeigeAnforderungen = !zeigeAnforderungen" class="hover:cursor-pointer text-Mittelblau">Anforderungen</div>
                        ...
                        <LayoutFormSection>
                        	<!-- <div class="flex gap-4">
                        		<button class="bg-Mittelblau hover:bg-Dunkelblau text-white px-3 py-2">IT und Rechnungswesen benachrichtigen</button>
                        		<button class="bg-Mittelblau hover:bg-Dunkelblau text-white px-3 py-2">WND: Personalverrechnung benachrichtigen</button>
                        		<button class="bg-Mittelblau hover:bg-Dunkelblau text-white px-3 py-2">KUF: Excel Info Liste an IT, Schulung und Telefonzentrale</button>
                        	</div> -->
                        	<div class="space-y-3">
