...
<template>
    <LayoutDashboardCard header="Abwesenheiten" buttonText="Abwesenheit erfassen" buttonLink="/hra/Abwesenheiten">
        <div class="px-3">
            <div class="grid grid-cols-[10rem_6rem_8rem_8rem] border-b text-sm font-bold text-muted bg-Blaugrau-10"> 
                <div class="px-2 py-1"> Abwesenheit </div>
                <div class="px-2 py-1"> Status </div>
                <div class="place-self-center py-1"> Von </div>
                <div class="px-2 py-1 text-center"> Bis </div>
            </div>

            <div v-for="abwesenheit, index in ma.abwesenheiten"  
                class="grid grid-cols-[10rem_6rem_8rem_8rem]  
              ...
              <div class="px-2 py-1 tabular-nums text-center">
                {{abwesenheit.von}}
              </div>
              <div class="px-2 py-1 tabular-nums text-center">
                {{abwesenheit.bis}}
