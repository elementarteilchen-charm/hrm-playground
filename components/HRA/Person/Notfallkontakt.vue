<script setup>
  ...
  const notfallkontakte = angehoerige.filter( person => person.notfallkontakt === true)
...
<template>
  ...
  <div>
    <h3 class="text-lg font-bold text-gray-900 ">Notfallkontakt</h3>
  ...
  <LayoutFormSection >
    <h3 class="text-lg font-bold text-gray-900 "></h3>
      ...
      <table class="table w-full text-sm bg-gray-50">
        ...
        <tbody class="">
          <tr 
              v-for="person, index in notfallkontakte" 
      ...
      <div class="mt-4 flex justify-end">
        <button @click="showDialog" class="bg-blue-700 text-white px-3 py-2">Weiteren Notfallkontakt hinzufügen</button>
      </div>
  </LayoutFormSection>
