...
<template>
  <div>
    <h3 class="text-lg font-bold text-gray-900 ">Konkurrenzklauseln</h3>
    ...
    <LayoutFormSection title="">
      <div class="grid lg:grid-cols-1 gap-4">
        <div class=" grid grid-cols-[minmax(6rem,min-content)_1fr] gap-2">  
          ...
          <InputText label="LKW" value="" width="w-64"/>
          <InputText label="WGS" value="" width="w-64"/>
          <InputText label="CXW" value="" width="w-64"/>
