...
function showDialog() {
    document.getElementById('dokumente-hinzufuegen-dialog').showModal();
}
...
<template>
    ...
    <div  class="bg-gray-100 p-4 rounded ">
        <h2 class="font-bold mb-2">Hinzugefügte Dokumente</h2>
                ...
                <tr v-for="dokument in hinzugefuegteDokumente" class="border-b">
                    ...
                    <td class=""> 
                        ...
                        <button class="place-self-center">
                            ...
                            <CheckCircleIcon @click="showDialog" class="text-green-400  w-5 h-5"/>
                        </button>
    ...
    <dialog id="dokumente-hinzufuegen-dialog" class="shadow-lg bg-gray-100 p-4">
