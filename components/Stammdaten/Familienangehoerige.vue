...
<template>
            ...
            <div class="grid grid-rows-[3rem_1fr_3rem] h-full">
                ...
                <main class="px-4 py-2" style="height: calc(100% - 1rem); overflow-y: auto;">
                  ...
                  <div class="mt-4 grid grid-cols-2 gap-4">
                    ...
                    <div class="border border-gray-400 rounded-md shadow-md w-48 h-16 bg-white p-4 flex space-x-2">
    ...
    <dialog id="nachweis-upload-dialog" class="modal shadow-lg bg-gray-100 p-4">
        <div class="grid grid-rows-[3rem_1fr_3rem] h-full">
          <header class="px-4 py-2 h-12  text-lg font-bold ">
